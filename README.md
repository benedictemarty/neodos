...
Édition de ligne : flèches, Début/Fin, Suppr, Échap ; **Haut/Bas** rappellent l'historique des commandes ; **Tab** complète le nom de fichier ou de répertoire sous le curseur ; **F8** rappelle la dernière commande commençant par le texte tapé (DOSKEY) ; en fin de ligne, la suite de la dernière commande correspondante est **suggérée en gris** au fil de la frappe (→ ou Fin pour l'accepter). **Ctrl+Alt+Suppr** redémarre NeoDOS à chaud.
