...
EXAMPLES = storage/HELLO.NEO storage/BIN/ARGS.NEO storage/BIN/MORE.NEO storage/BIN/TREE.NEO storage/BIN/XCOPY.NEO storage/BIN/DELTREE.NEO storage/BIN/FIND.NEO storage/BIN/SORT.NEO storage/AUTOEXEC.BAT storage/DEMO.BAT
