...
EXAMPLES = storage/HELLO.NEO storage/BIN/ARGS.NEO storage/BIN/MORE.NEO storage/BIN/TREE.NEO storage/BIN/XCOPY.NEO storage/BIN/DELTREE.NEO storage/BIN/FIND.NEO storage/BIN/SORT.NEO storage/BIN/EDIT.NEO storage/BIN/ATTRIB.NEO storage/BIN/REBOOT.NEO storage/BIN/COLOR.NEO storage/AUTOEXEC.BAT storage/DEMO.BAT
...
storage/BIN/%.NEO: examples/ext/%.asm examples/ext/neoext.inc examples/ext/walk.inc examples/ext/glob.inc tools/mkneo.py | $(BUILD)
	mkdir -p storage/BIN
